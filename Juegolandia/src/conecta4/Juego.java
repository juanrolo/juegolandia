...
public class Juego {
    ...
    *************************************************************/
    ...
    /**
    *Crea un thread donde se ejecutar� JugandorMaquina para que calcule la jugada.
    * @param jugador JugandorMaquina que est� jugando.
    ...
    */
    public int jugadaMaquina(JugadorMaquina jugador)
    {
    	...
    	if(m_turno == jugador.m_jugador)
    	{
    		...
    		//Se espera e inicia el tread para que el jugador m�quina calcule la jugada.
