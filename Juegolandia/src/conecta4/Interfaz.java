...
public class Interfaz extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		setTitle("Pr√°ctica Sistemas Inteligentes");
		setResizable(false);
		...
		jButtonHM.setText("Humano/M√°quina");
		...
		jButtonMM.setText("M√°quina/M√°quina");
		...
		layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
				.add(layout.createSequentialGroup()
						.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
								.add(layout.createSequentialGroup().add(20, 20, 20).add(jButtonHH)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(jButtonHM)
										.addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED).add(jButtonMM))
								...
								.add(layout
										.createSequentialGroup().addContainerGap().add(jLabel1,
												org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 408, Short.MAX_VALUE)
										.add(73, 73, 73)))
						.addContainerGap()));
		layout.setVerticalGroup(
				layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
						.add(layout.createSequentialGroup()
								.add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE).add(jButtonHH)
										.add(jButtonHM).add(jButtonMM))
								.add(18, 18, 18).add(jLabel1).add(32, 32, 32)
	...
	// Funci√≥n que se ejecuta al pulsar el bot√≥n Humano/Humano
	...
	// Funci√≥n que se ejecuta al pulsar el bot√≥n M√°quina/M√°quina
	private void jButtonMMActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonMMActionPerformed
		// Debe indicar que el modo de juego es M√°quina/M√°quina
	...
	// Cuando se mueve el rat√≥n por el panel se ejecuta este evento
	// Dibuja en la parte superior de la ventana la ficha que va a colocar el
	// jugador
	private void jPanel1MouseMoved(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jPanel1MouseMoved
		...
		// √önicamente tiene que dibujar la ficha si es el turno del jugador
		// humano:
		// En caso que el turno sea del jugador 1 en el caso de Humano/M√°quina
		// o el cualquier caso si estamos en el modo Humano/Humano
		// y adem√°s √∫nicamente, si el juego ha empezado.
		if (m_nuevoJuego.getJugando()) {
			if (m_nuevoJuego.getModo() == 1 || (m_nuevoJuego.getModo() == 2 && m_nuevoJuego.getTurno() == 1)) {
				// Determina a qu√© columna est√° m√°s cercano el rat√≥n
				// Calcula el tama√±o de cada casilla
				...
				// Calcula la columna m√°s cercana en la que se encuentra el
				// rat√≥n
				...
				if (columna >= 0 && columna < m_nuevoJuego.m_tablero.numColumnas()) {
					...
					// Antes de dibujar la ficha realiza un borrado por si
					// hab√≠a una ficha anterior
					g.setColor(jPanel1.getBackground());
					g.fillRect(0, 0, jPanel1.getSize().width, 50);

					// Para saber de qu√© color tiene que dibujar la ficha
					// comprueba el turno
					...
					// Dibuja la ficha
					g.fillOval((int) (margenAncho) + (int) (columna * anchoCasilla + 20), 5, (int) (0.8 * altoCasilla),
							(int) (0.8 * altoCasilla));
				}
			}
		}
	...
	// Esta funci√≥n inserta la ficha en el tablero cuando el jugador hace clic
/*	private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jPanel1MouseClicked
		float anchoCasilla, altoCasilla, margenAncho;
		int columna;

		// √önicamente tiene que insertar la ficha si es el turno del jugador
		// humano:
		// En caso que el turno sea del jugador 1 en el caso de Humano/M√°quina
		// o el cualquier caso si estamos en el modo Humano/Humano
		// y adem√°s √∫nicamente, si el juego ha empezado.
		if (m_nuevoJuego.getJugando()) {
			if (m_nuevoJuego.getModo() == 1 || (m_nuevoJuego.getModo() == 2 && m_nuevoJuego.getTurno() == 1)) {
				...
				if (columna >= 0 && columna < m_nuevoJuego.m_tablero.numColumnas()) {
					...
					// Antes de dibujar la ficha realiza un borrado por si habÌa
					// una ficha anterior
					g.setColor(jPanel1.getBackground());
					g.fillRect(0, 0, jPanel1.getSize().width, 50);

					// Para saber de quÈ color tiene que dibujar la ficha
					// comprueba el turno
					if (m_nuevoJuego.getTurno() == 1)
						g.setColor(Color.RED);
					else
...
*/
	// Esta funciÛn inserta la ficha en el tablero cuando el jugador hace clic
	private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_jPanel1MouseClicked
		float anchoCasilla, altoCasilla, margenAncho;
		int columna;

		// ⁄nicamente tiene que insertar la ficha si es el turno del jugador
		// humano:
		// En caso que el turno sea del jugador 1 en el caso de Humano/M·quina
		// o el cualquier caso si estamos en el modo Humano/Humano
		// y adem·s ˙nicamente, si el juego ha empezado.
		if (m_nuevoJuego.getJugando()) {
			if (m_nuevoJuego.getModo() == 1 || (m_nuevoJuego.getModo() == 2 && m_nuevoJuego.getTurno() == 1)) {
				// Determina a quÈ columna est· m·s cercano el ratÛn
				// Calcula el tamaÒo de cada casilla
				anchoCasilla = (jPanel1.getSize().width - 40) / m_nuevoJuego.m_tablero.numColumnas();
				altoCasilla = (jPanel1.getSize().height - 70) / m_nuevoJuego.m_tablero.numFilas();
				margenAncho = (float) (0.2 * anchoCasilla);
				...
				if (columna >= 0 && columna < m_nuevoJuego.m_tablero.numColumnas()) {
					...
					if (m_nuevoJuego.getJugando()) {
						...
						// Si el juego aun no ha terminado y est· en modo de
						// juego 2
						// Humano/M·quina despuÈs de poner ficha el humano debe
						// ponerlo la m·quina
	...
	// OpciÛn "Nuevo Juego" del men˙ Archivo
	private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jMenuItem1ActionPerformed
		// Llama a la funciÛn que limpia el tablero y establece los par·metros
		// iniciales
	...
	// End of variables declaration//GE-END:variables
	...
	public void paint(Graphics g) {
		...
		// Calcula el tamaÒo que tendra el tablero. Le resta los margenes
		// izquierdo y superior respectivamente.
		anchuraTablero = jPanel1.getSize().width - 40;
		alturaTablero = jPanel1.getSize().height - 70;

		// Como estamos sobreescribiendo la funcion llamos a la funcion padre.
		super.paint(g);
		g = jPanel1.getGraphics();

		// Dibuja el tablero como un rectangulo azul.
		g.setColor(Color.BLUE);
		g.fillRect(20, 50, ((int) anchuraTablero), ((int) alturaTablero));

		// Una vez dibujando el tablero, crea cada una de las casillas del
		// tablero.

		// Calcula el tamaÒo que ocupar· cada casilla a partir del tamaÒo del
		// tablero.
		...
		// Dibuja cada una de las casilla
		for (int i = 0; i < m_nuevoJuego.m_tablero.numColumnas(); i++) {
			for (int j = 0; j < m_nuevoJuego.m_tablero.numFilas(); j++) {
				...
				if (m_nuevoJuego.m_tablero.obtenerCasilla(j, i) == 1) {
					...
					// Si la casilla pertenece al jugador 2, la dibuja de color
					// amarillo
					if (m_nuevoJuego.m_tablero.obtenerCasilla(j, i) == 2) {
						g.setColor(Color.YELLOW);
					} else {
						// Si la casilla est· vacÌa, la dibuja de color negro
						g.setColor(Color.darkGray);
					}
				}
				// Calcula la posicion en la que debe dibujar la casilla
				x = (int) (i * anchoCasilla + 20);
				y = (int) (alturaTablero) - (int) (j * altoCasilla);

				// Dibuja la casilla
				g.fillOval((int) (x + margenAncho), (int) (y + margenAlto), (int) (0.8 * altoCasilla),
						(int) (0.8 * altoCasilla));
			}
		}
		EscribeMensaje();
	...
	public void EscribeMensaje() {
		...
		case 0:
			...
			break;
		case 1:
			jLabel1.setText("Turno del jugador " + m_nuevoJuego.getTurno() + ".");
			break;
		case 2:
			jLabel1.setText("Ha ganado el jugador " + m_nuevoJuego.getTurno() + ".");
			break;
		case 3:
			jLabel1.setText("Empate.Tablero lleno.");
			break;
		case 4:
			jLabel1.setText("El jugador" + m_nuevoJuego.getTurno() + " ha colocado una ficha incorrectamente.");
			break;
		default:
			jLabel1.setText(" ");
			break;
